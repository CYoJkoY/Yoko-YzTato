...
func _init():
    ...
    var extensions: Array = [
        ...
        "entity_spawner.gd",
        # EFFECTS: gain_stat_when_killed_single_scaling[ 1/3 ]
        #           blood_rage[ 1/2 ]
        ...
        #          leave_fire[ 1/2 ]
        #          gain_stat_when_killed_single_scaling[ 2/3 ]
        #          multi_hit[ 1/2 ]
        #          vine_trap[ 1/2 ]
        #          upgrade_when_killed_enemies[ 2/4 ]
        # ACHIEVE: counterattack 

        "ranged_weapon.gd",
        # EFFECTS: upgrade_when_killed_enemies[ 3/4 ]
        #          boomerang_weapon
        #          leave_fire[ 2/2 ]
        #          multi_hit[ 2/2 ]
        #          vine_trap[ 2/2 ]
