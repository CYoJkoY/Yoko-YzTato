...
func get_args(_player_index: int) -> Array:
    ...
    var max_damage_mul_arg: String = "[color=#%s]%s[/color]" % [ProgressData.settings.color_positive, str(max_damage_mul * 100)]
    var min_damage_mul_arg: String = "[color=#%s]%s[/color]" % [ProgressData.settings.color_negative, str(min_damage_mul * 100)]
